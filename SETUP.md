...
Self-hosted **платформа сообщества Telegram ↔ Discord** для **одного** канала и/или **одного** Discord-сервера. Предложка, мост, модерация и другие модули — в одном процессе.
