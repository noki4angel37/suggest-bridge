...
DOWNLOAD_INSTRUCTIONS = "\n".join(
    (
        ...
        "   .\\install-agent.ps1",
        "4) Заполните local.env (из local.env.example):",
        "   BOT_TOKEN, DISCORD_TOKEN, ADMIN_IDS, CHANNEL_ID, OWNER_*",
        ...
        "requirements.txt, local.env.example.",
        "Секреты (local.env) в архив не входят — возьмите у владельца.",
        "",
