...
- узнать о новых версиях бота и изменениях;
- задать вопрос по использованию (для подписчиков и администраторов);
...
| Не здесь | Куда идти |
|----------|-----------|
| Официальная поддержка Telegram / Discord | [support.telegram.org](https://telegram.org/support), [Discord Support](https://support.discord.com) |
